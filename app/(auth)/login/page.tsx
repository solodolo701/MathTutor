...
export default function LoginPage() {
  ...
  async function handleGoogleLogin() {
    ...
    if (error) setError("Google bejelentkezés sikertelen.");
    setLoading(false);
  }
      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-zinc-900 border border-zinc-800 rounded-xl p-8">
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 px-4 py-3 bg-white hover:bg-zinc-100 text-zinc-900 rounded-lg font-medium transition-colors disabled:opacity-50 mb-6"
          >
          ...
          <div className="relative mb-6">
            ...
            <div className="relative flex justify-center text-sm">
              <span className="px-2 bg-zinc-900 text-zinc-500">vagy</span>
            </div>
          </div>
